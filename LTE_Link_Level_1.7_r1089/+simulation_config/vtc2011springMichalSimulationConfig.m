classdef vtc2011springMichalSimulationConfig < simulation_config.simulatorConfig
    methods (Static)
        function LTE_params = apply_parameters(LTE_params,estimator,speed)
            ...
            LTE_params.UE_config.channel_estimation_method = estimator;      %'PERFECT','LS','MMSE'
            ...
            LTE_params.UE_config.receiver = 'ICI_aware_ZF'; % 'SSD','ZF'
            LTE_params.UE_config.user_speed = speed;    %[m/s]
            ...
            LTE_params.ChanMod_config.filtering = 'FastFading';  %'BlockFading','FastFading'
            LTE_params.ChanMod_config.type = 'Rayleigh2'; % 'PedA', 'PedB', 'PedBcorr', 'AWGN', 'flat Rayleigh','VehA','VehB','TU','RA','HT','winner_II'
            %% Scheduler settings
