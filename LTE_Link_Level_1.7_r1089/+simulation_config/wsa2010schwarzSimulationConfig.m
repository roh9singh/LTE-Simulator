classdef wsa2010schwarzSimulationConfig < simulation_config.simulatorConfig
    methods (Static)
        function LTE_params = apply_parameters(LTE_params,nRX,nTX,receiver,channel)
            ...
            LTE_params.ChanMod_config.type = channel; % 'PedA', 'PedB', 'PedBcorr', 'AWGN', 'flat Rayleigh','VehA','VehB','TU','RA','HT','winner_II'
            %% Scheduler settings
            ...
            %   - For 'fixed': 'semi static': PMI and RI are adjusted dynamically (CQI
            %   is kept constant)
