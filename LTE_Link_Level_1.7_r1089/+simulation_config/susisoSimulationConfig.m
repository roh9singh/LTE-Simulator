classdef susisoSimulationConfig < simulation_config.simulatorConfig
    % Simulation parameters for a SUSISO simulation
    ...
    methods (Static)
        function LTE_params = apply_parameters(LTE_params)
            ...
            LTE_params.introduce_timing_offset =  true;
            ...
            LTE_params.UE_config.timing_sync_method = 'perfect';% 'perfect','none', 'autocorrelation', 'min_energy', 'energy_transition','modified_energy_transition'
            LTE_params.UE_config.carrier_freq_offset = pi;   % carrier frequency offset normalized to subcarrier spacing
            LTE_params.UE_config.freq_sync_method = 'perfect';   %'perfect','none','estimated'
