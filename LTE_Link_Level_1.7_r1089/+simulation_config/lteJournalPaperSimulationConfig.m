classdef lteJournalPaperSimulationConfig < simulation_config.simulatorConfig
    methods (Static)
        function LTE_params = apply_parameters(LTE_params,N_Ue,N_Bs,tx_mode,N_rx,N_tx,channel_type,connection_table,Power_diff,channel_est,equalizer)
            ...
            LTE_params.UE_config.channel_estimation_method = channel_est; %'PERFECT';      %'PERFECT','LS','MMSE'
            ...
            LTE_params.UE_config.receiver = equalizer; % 'SSD','ZF'
