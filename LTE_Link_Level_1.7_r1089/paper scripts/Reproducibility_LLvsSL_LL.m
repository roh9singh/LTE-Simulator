...
cqi_i = 4;
N_subframes = 2500;  
disp('Reduce the number of subframes (N_subframes) in "Reproducibilty_LLvsSL_LL.m"') 
...
for loop_i = 1:4
    ...
    switch loop_i
        ...
        case 3
            ...
            LTE_load_parameters_generate_elements;
            LTE_check_parameters;
            output_filename = 'OLSM_TU_LL';
        case 4
            LTE_params.UE_config.mode = 4;                    
            LTE_params.UE_config.nRX = 2;  
            LTE_params.BS_config.nTx = 4;
            LTE_load_parameters_dependent;
            LTE_load_parameters_generate_elements;
            LTE_check_parameters;
            output_filename = 'CLSM_TU_LL';
    end
    LTE_sim_main;
